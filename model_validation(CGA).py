...
def load_data(folder_path):
    ...
    for file_name in os.listdir(folder_path):
        ...
        if 'lie' in file_name:
            ...
            true_label = 5
        elif 'turnleft' in file_name:
            true_label = 6
        elif 'turnright' in file_name:
            true_label = 7
        elif 'upstairs' in file_name:
            true_label = 8
        elif 'downstairs' in file_name:
            true_label = 9
...
if __name__ == '__main__':
    ...
    X, Y = load_data(r'Datasets/Coarse-Grained Activities Dataset')
    ...
    model = Model(9, 16, 10).to(device)
    criterion = nn.CrossEntropyLoss()

    checkpoint_path = r'Experiment Data/Comparison Experiment/Coarse-Grained Activities/TFSNet/best.pt'
